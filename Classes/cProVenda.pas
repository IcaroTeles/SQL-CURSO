...
type
  ...
  private
    ...
    F_totalVenda: Double;
    F_formapagamento: string;
    F_dataentrega: TDateTime;
  ...
  published
    ...
    property dataentrega:TDateTime read F_dataentrega write F_dataentrega;
    property formapagamento:string read F_formapagamento  write F_formapagamento;
  end;
...
begin
  try
    ...
    Qry.ParamByName('dataentrega').AsDateTime    :=Self.F_dataentrega;
    Qry.ParamByName('formapagamento').AsString   :=Self.F_formapagamento;
...
begin
  ...
  try
    ...
    Qry.SQL.Clear;
    Qry.SQL.Add('INSERT INTO vendas (clienteId, dataVenda, totalVenda, dataentrega, formapagamento)  '+
                '            VALUES (:clienteId,:dataVenda,:totalVenda, :dataentrega, :formapagamento )');
    Qry.ParamByName('clienteId').AsInteger  :=Self.F_clienteId;
    Qry.ParamByName('dataVenda').AsDateTime :=Self.F_dataVenda;
    Qry.ParamByName('totalVenda').AsFloat   :=Self.F_totalVenda;
    Qry.ParamByName('dataentrega').AsDateTime  :=Self.F_dataentrega;
...
begin
  try
    ...
    Try
      ...
      Self.F_dataentrega  := Qry.FieldByName('dataentrega').AsDateTime;
      Self.F_formapagamento  := Qry.FieldByName('formapagamento').AsString;
